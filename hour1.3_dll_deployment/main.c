/* pqview - PostgreSQL Query Client - Hour 1.3: DLL Deployment */
/* Basic window with PostgreSQL connection test - DLLs automatically copied */
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    switch (uMsg)
    {
        ...
        case WM_PAINT:
        {
            ...
            const char* text = "pqview - Hour 1.3: DLL Deployment";
            const char* subtext = "PostgreSQL DLLs automatically copied!";
