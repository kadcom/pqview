...
void Controls_Resize(HWND hwnd, const ControlHandles* handles)
{
    ...
    int availableHeight;
    int resultsY;   /* C89: declare at top */
    int buttonY;    /* C89: declare at top */
    int debugY;     /* C89: declare at top */
    ...
    resultsY = margin + connectionHeight + 10 + connectButtonHeight + 10 + queryGroupHeight + 10;
    ...
    buttonY = resultsY + resultsGroupHeight - 35;
    ...
    debugY = resultsY + resultsGroupHeight + 10;
